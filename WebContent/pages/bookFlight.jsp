...
<body>
	...
	<s:form action="finishBookingAFlight" method="post" id="msform">
		...
		<fieldset id="step1">
			...
			<label>Departure : </label><s:textfield type="date" name="departureDay" style="width:190px"></s:textfield>	
			<label>Arrival :   </label><s:textfield type="date" name="arrivalDay" style="width:210px"></s:textfield>	
